...
import { AppBar, Box, Text } from 'vajra-ui';
      ...
      <Box flex={1} bg="background" gap="s-6">
        ...
        <Section title="Back + Title">
          <AppBar.Header useSafeArea={false} bg="info">
            <AppBar.BackAction icon={ArrowLeft} onPress={() => handlePress('back')} />
            <AppBar.Title>Screen Title</AppBar.Title>
          </AppBar.Header>
        </Section>
        ...
        <Section title="Back + Centered Title + Action">
          <AppBar.Header useSafeArea={false}>
            <AppBar.BackAction icon={ArrowLeft} onPress={() => handlePress('back')} />
            <AppBar.Title centered>Screen Title</AppBar.Title>
            <AppBar.IconButton icon={Search} onPress={() => handlePress('search')} accessibilityLabel="Search" />
          </AppBar.Header>
        </Section>
        ...
        <Section title="Back + Centered Title + Multiple Actions">
          <AppBar.Header useSafeArea={false}>
            <AppBar.BackAction icon={ArrowLeft} onPress={() => handlePress('back')} />
            <AppBar.Title centered>Screen Title</AppBar.Title>
            <AppBar.IconButton icon={Heart} onPress={() => handlePress('favourite')} accessibilityLabel="Favourite" />
            <AppBar.IconButton icon={MoreVertical} onPress={() => handlePress('more')} accessibilityLabel="More options" />
          </AppBar.Header>
        </Section>
