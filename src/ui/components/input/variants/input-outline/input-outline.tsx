...
const InputOutlineComponent = forwardRef<RNTextInput, TInputProps>(
  (
    {
      label,
      helperText,
...
InputOutlineComponent.displayName = 'Input.Outline';

export const InputOutline = InputOutlineComponent;
